...
Date: 2024-12-29 22:41:02
LastEditors: ansvver an5vv3r@outlook.com
LastEditTime: 2024-12-29 22:59:03
FilePath: \a-code-log\leetcode\000-start\1422.分割字符串的最大得分.py
Description: 
...
class Solution:
    def maxScore(self, s: str) -> int:
        ...
        ret = score = 1 + s[1:].count('1') if s[0] == '0' else s[1:].count('1')
        for c in s[1:-1]:
            if c == '0':
                score += 1
            else:
